...
def inputKW(string,keys,browser):
	...
	try: 
		...
		{'secure': False, 'name': 'BMR', 'httpOnly': False, 'domain': '.naver.com', 'path': '/', 'value': urllib.parse.urlencode({'s':'1579758227884','r':'https://m.blog.naver.com/CommentList.nhn?blogId=melina526&logNo=110084850684','r2': 'https://m.blog.naver.com/PostView.nhn?blogId=melina526&logNo=110084850684','proxyReferer':'https://www.google.com/'}), 'expiry': 1592867810}, 
		{'secure': False, 'name': 'MM_WEBT_LIGHT', 'httpOnly': False, 'domain': 'm.naver.com', 'path': '/', 'value': '1', 'expiry': 1579901644}, 
